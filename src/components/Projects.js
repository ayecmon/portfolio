...
export const Projects = () => {
  const webProject = [
    {
      title: "New Space",
      description: "New Space is a dynamic social media platform that blends the visual engagement of Instagram with the community-driven discussions of Reddit.\nIt allows users to connect with friends, share content, and engage in meaningful conversations, creating an interactive and engaging social experience.",
      imgUrl: projImg1,
    },
  ];
                ...
                <Tab.Content>
                  ...
                  <Row>
                      ...
                      <Col sm = {3}>
                        ...
                        <a href="https://new-space.netlify.app/" target="_blank" rel="noopener noreferrer">
                        Visit Live App
                        </a> 
                        </div>
                        <div className = "git-link">
                        <a href="https://github.com/FutureWave-Technologies-LLC/DummyWebsiteReact2.git" target="_blank" rel="noopener noreferrer">
                        Git Repo
                        </a> 
                        </div>
                      </Col>
                  ...
                  <Tab.Pane eventKey="second">
                    <Row>
                      ...
                      <Col sm = {3}>
                        <div className = "proj-link">
                        <a href="https://play.google.com/store/apps/details?id=com.ayecmon.welift" target="_blank" rel="noopener noreferrer">
                        Visit Live App
                        </a> 
                        </div>
                        <div className = "git-link">
                        <a href="https://github.com/ayecmon/We_Lift.git" target="_blank" rel="noopener noreferrer">
                        Git Repo
                        </a> 
                        </div>
                      </Col>
                  ...
                  <Row>
                      ...
                      <Col sm = {3}>
                      <div className = "proj-link">
                        <a href="https://github.com/ayecmon/AI-animeFaceDetector.git" target="_blank" rel="noopener noreferrer">
                        Visit Live App
                        </a> 
                        </div>
                        <div className = "git-link">
